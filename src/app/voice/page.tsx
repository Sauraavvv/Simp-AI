...
import { useHangupWhenSpoken } from "@/lib/useHangupWhenSpoken";
...
function VoiceCall() {
  ...
  // Hang up once the last free turn has been heard -- not when it is sent, and
  // not when the stream closes. Both of those cut the answer off; see
  // useHangupWhenSpoken, which is where that reasoning and its tests live.
  useHangupWhenSpoken({
    phase: call.phase,
    active: call.active,
    reached: guestLimitReached,
    end: call.end,
  });
